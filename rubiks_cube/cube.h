...
public:
	...
	void Draw()
	{
		...
		//------------------верх-------------------------------
		cubiks[2][0][0].drawsmallcube(-1, -1, 0.08);
		cubiks[2][1][0].drawsmallcube(-0.49, -1, 0.08);
		cubiks[2][2][0].drawsmallcube(0.02, -1, 0.08);

		cubiks[2][0][1].drawsmallcube(-1, -0.47, 0.08);
		cubiks[2][1][1].drawsmallcube(-0.49, -0.47, 0.08);
		cubiks[2][2][1].drawsmallcube(0.02, -0.47, 0.08);

		cubiks[2][0][2].drawsmallcube(-1, 0.07, 0.08);
		cubiks[2][1][2].drawsmallcube(-0.49, 0.07, 0.08);
		cubiks[2][2][2].drawsmallcube(0.02, 0.07, 0.08);
		//-------------------верх--------------------------
